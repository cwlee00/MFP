...
from .modeling.swin_transformer import SwinTransfomerSegHead_prevMod
...
class PlainVitModel_prevMod(ISModel_prevMod):
    ...
    def backbone_forward(self, image, coord_features=None, prev_mask=None, prev_mask_modulated=None):
