...
def get_results_table(noc_list, over_max_list, brs_type, dataset_name, mean_spc, elapsed_time,
    ...
    table_header = (f'|{"BRS Type":^13}|{"Dataset":^11}|'
                ...
                f'{"NoF@85%":^9}|{"NoF@90%":^9}|{"NoF@95%":^9}|{"NoF@99%":^9}|{"NoF@100%":^9}|'
                f'{"SPC,s":^7}|{"Time":^9}|')
    ...
    table_row += f'{over_max_list[0]:^9}|' if len(noc_list) > 1 else f'{"?":^9}|'
    table_row += f'{over_max_list[1]:^9}|' if len(noc_list) > 0 else f'{"?":^9}|'
