...
class FirstPointSampler(BasePointSampler):
    ...
    def sample_points(self):
        assert self._selected_mask is not None
        assert self._selected_masks is not None
        ...
        neg_points = [(-1, -1, -1)] * self.max_num_points
    ...
    def _multi_mask_sample_points(self, selected_masks, is_negative, with_first_click=False):
        ...
        each_obj_points = [
            self._sample_center_points(mask)
    ...
    def _sample_center_points(self, mask):
